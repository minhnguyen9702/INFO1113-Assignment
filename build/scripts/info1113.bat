...
@rem ##########################################################################
@rem
@rem  info1113 startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and INFO1113_OPTS to pass JVM options to this script.
...
@rem Execute info1113
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %INFO1113_OPTS%  -classpath "%CLASSPATH%" WizardTD.App %*
...
:fail
rem Set variable INFO1113_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
set EXIT_CODE=%ERRORLEVEL%
if %EXIT_CODE% equ 0 set EXIT_CODE=1
if not ""=="%INFO1113_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
